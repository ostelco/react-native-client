...
const Payment = props => {
  const { style, goBack, confirm, isDialogVisible, price , topUpAmount} = props;
  return (
    <Container style={{ position: 'relative', backgroundColor: colors.whiteTwo, overflow: 'hidden' }}>
        ...
        <View style={{ width: '100%', justifyContent: 'center' }}>
          <View style={{ backgroundColor: colors.white, padding: 30 }}>
            ...
            <View style={{ padding: 50 }}>
              <Text style={textStyles.textStyle24}>{topUpAmount}</Text>
            </View>
      ...
      <Content contentContainerStyle={style.content} bounces={false}>
        <View style={{ padding: 30 }}>
          <Text style={textStyles.textStyle20}>{topUpAmount}</Text>
          <Text style={textStyles.textStyle7}>{price}</Text>
        </View>
        ...
        <View style={{ alignSelf: 'flex-end', paddingHorizontal: 45, width: '100%', paddingBottom: 75 }}>
          <View style={{
            ...
            <TouchableHighlight onPress={confirm}>
              <Text style={textStyles.textStyle6}>{price}</Text>
            </TouchableHighlight>
          </View>
        </View>
      </Content>
