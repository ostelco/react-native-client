...
const CardList = compose(
  connect(({ remoteConfig }) => ({ showAddCardButton: remoteConfig.featureFlagEnableAddNewCreditCard }))
  )(props => {
  ...
  return (
    <Container style={styles.container}>
      ...
      <Content contentContainerStyle={styles.content} scrollEnabled={false}>
        ...
        ) : (featureFlagEnableAddNewCreditCard ? (
